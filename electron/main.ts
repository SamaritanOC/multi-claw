import { app, BrowserWindow, shell, session, Menu, MenuItem, dialog } from 'electron'
...
async function createMCWindow(config?: WinConfig) {
  ...
  // Right-click context menu for renaming and new window
